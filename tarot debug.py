...
tarot_draw = ['King of Cups', 'Four of Pentacles', 'Queen of Cups']
# tarot_draw = []
# for _ in range(3):
...
context = "Aaron & Nicolle 14 Apr 24"
...
with open(log_file_path, "a") as log_file:
    ...
    log_file.write(f"Model: {gpt_model}\n")
    log_file.write(f"Temperature: {gpt_temperature}\n")
...
# Example usage
# add_tarot_reading_to_notion(context, tarot_draw, tarot_reading, current_datetime)